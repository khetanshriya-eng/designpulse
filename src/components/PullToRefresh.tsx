...
export function PullToRefresh() {
  ...
  useEffect(() => {
    ...
    const onStart = (e: TouchEvent) => {
      // Don't hijack the gesture while a bottom sheet / modal is open (it sets
      // this flag) — otherwise dragging the sheet's handle down bubbles up here
      // and fires the refresh loader instead of dismissing the sheet.
      if (
        scrollTop() > 0 ||
        busyRef.current ||
