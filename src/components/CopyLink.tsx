 ...
 */
export function CardCopyOverlay({ url }: { url: string }) {
  return (
    <CopyLink
      url={url}
      compact
      ...
      className="absolute top-2 right-2 z-10 grid place-items-center p-1.5 border-2 border-[#1a1340] bg-[#1a1340] shadow-[2px_2px_0_var(--card-shadow)] opacity-0 group-hover:opacity-100 focus-visible:opacity-100 [@media(hover:none)]:opacity-90 transition-opacity"
    />
  );
}
