...
const SQUARES: [number, number, number, number, number, number][] = [
  [6, 12, 6, 0, 46, 0], [16, 70, 5, 2, 58, 3], [27, 30, 8, 1, 40, 6],
  [38, 85, 5, 3, 52, 1], [47, 18, 6, 4, 62, 4], [58, 55, 7, 0, 44, 2],
  [66, 8, 5, 2, 56, 7], [74, 78, 6, 1, 48, 5], [83, 36, 8, 3, 60, 0],
  [92, 64, 5, 4, 42, 3], [11, 46, 6, 1, 54, 8], [34, 60, 5, 0, 50, 2],
  [52, 90, 7, 2, 64, 6], [70, 44, 6, 4, 46, 1], [88, 16, 5, 3, 58, 4],
  [22, 92, 6, 0, 50, 9],
];
